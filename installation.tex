...
\begin{frame}[fragile]{Accès client à la base de données}
   ...
   \begin{itemize}
      \item Le lien suivant décrit comment se logger à la base de données PostgreSQL: \url{https://github.com/zalando/postgres-operator/blob/master/docs/user.md#connect-to-postgresql}
