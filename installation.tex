...
\begin{frame}[fragile]{Utilisation de container en mode rootless dans OpenShift}
   ...
   L'URL suivante décrit la problèmatique d'utilisation de container dans un environnement rootless: \url{https://docs.bitnami.com/tutorials/running-non-root-containers-on-openshift}
