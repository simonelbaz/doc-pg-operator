...
\begin{frame}[fragile]{Déploiement de la couche réseau - \textbf{Container Network Interface}}
   ...
   Il existe différentes plugins Kubernetes implémentant l'interface CNI.\\
   Ces plugins sont listés dans l'URL suivante: \url{https://kubernetes.io/docs/concepts/cluster-administration/addons/}
