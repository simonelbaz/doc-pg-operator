...
\definecolor{redlina}{HTML}{c61d42}
...
\setbeamercolor{background canvas}{bg=redlina}
...
\includegraphics[width=8cm,height=8cm]{os_logo.png}
\includegraphics[]{linagora_logo.png}
}
